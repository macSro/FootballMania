...
public class ArticlesCheckServlet extends HttpServlet {
    @Override
    public void doPost(HttpServletRequest request, HttpServletResponse response) {
        ...
        try{
            ...
            System.out.println("ArticlesCheckServlet\n");
            ...
            if(errorCode != 0)
                ...
                int articleCode = ServerUtils.SERVER_NO_NEW_ARTICLES_CODE;
                ...
                if(dbConnection.checkForNewArticles(mobileLastUpdatedArticlesDate))
                    articleCode = ServerUtils.SERVER_NEW_ARTICLES_CODE;

                responseJSON.put(ServerUtils.ARTICLES_CODE, articleCode);
            }
